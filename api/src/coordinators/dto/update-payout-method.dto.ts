...
// How the coordinator wants their 8% fee paid. `method` selects the channel;
// only that channel's fields are required (the service validates and clears the
// other). Mirrors the nurse payout DTO.
